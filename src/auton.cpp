...
void pos4ringred() { //4ring
    ...
    pros::delay(75);
    //pros::delay(8000);
    chassis.turnToHeading(36, 600, {}, false);
    setIntake(0);

    // //Get Mobile Goal
    chassis.moveToPoint(-14.9,-11.5, 700, {}, false); //-15.6,-11.6
    chassis.turnToHeading(33, 500, {}, false); //42
    pros::delay(200);
    ...
    chassis.moveToPoint(-35,-34.8,1500,{.forwards = false, .maxSpeed = 100},false); //60
    ...
    chassis.moveToPoint(-23.5, -44, 800, {.minSpeed = 127}, false);
    ...
    chassis.turnToHeading(90, 600, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE}, false);
    ...
    chassis.moveToPoint(-18, chassis.getPose().y, 1800, {}, true);
    clamp.set_value(true);


}

void pos4ringblue() { //4ring
    ...
    // //Get Mobile Goal
    chassis.moveToPoint(15,-19, 700, {}, false); //-15.6,-11.6
    chassis.turnToHeading(-76, 500, {}, false); //42
    pros::delay(200);
    doinker.set_value(true);
    pros::delay(100);
    setDrive(2000,2000);
    ...
    // chassis.turnToHeading(45, 500, {}, false);
    chassis.moveToPoint(35,-30.8,1500,{.forwards = false, .maxSpeed = 60},false);
    chassis.turnToHeading(-100, 600, {}, false);
    doinker.set_value(false);

    chassis.turnToHeading(-65, 500, {}, false);
    setIntake(127);
    chassis.moveToPoint(19.5,-26, 600,{},false);
    chassis.turnToHeading(-90, 500, {}, false);

    chassis.moveToPoint(24, chassis.getPose().y, 800, {.forwards = false}, false);
    chassis.turnToHeading(-180, 600, {}, false);
    chassis.moveToPoint(24, -44, 800, {.minSpeed = 127}, false);
    chassis.moveToPoint(24, -25, 800, {.forwards = false}, false);
    pros::delay(300);
    // //chassis.moveToPoint(chassis.getPose().x, -36.6, 800, {.forwards = false}, false);

    chassis.turnToHeading(-90, 700, {}, false);
    chassis.moveToPoint(67,-32, 800, {.forwards = false}, false);
    chassis.turnToHeading(-200, 700, {}, false);
...
void provincialsBluePosQual(){
    ...
    chassis.moveToPoint(57.375, -26, 1000, {}, false);
    chassis.turnToHeading(90, 650, {}, false);
    chassis.moveToPoint(23, -24, 1500, {.forwards=false, .maxSpeed=60}, true);
    ...
    chassis.turnToHeading(180, 600, {}, false);
    setIntake(127);
    chassis.moveToPoint(29, -44, 1800, {}, false);
    pros::delay(300);
    // setIntake(0);
    ...
    chassis.moveToPoint(18,-27,1500, {}, true);
    ...
    // chassis.moveToPoint(57.375, -25, 1000, {}, false);
    // chassis.turnToHeading(90, 650, {}, false);
    // chassis.moveToPoint(21, -25, 1500, {.forwards=false, .maxSpeed=60}, true);
...
void provincialsRedPosQual(){
    ...
    setIntake(0);
    //chassis.turnToHeading(-90, 650, {}, false);
    chassis.moveToPoint(-17, -20, 1700, {.forwards=false, .maxSpeed=60}, true);
    ...
    chassis.turnToHeading(180, 600, {}, false);
    setIntake(127);
    chassis.moveToPoint(-29, -36, 1800, {}, false);
    pros::delay(300);
    // setIntake(0);

    // chassis.turnToHeading(-112, 450, {}, false);
    chassis.turnToHeading(-145, 450, {}, false);
    setIntake(127);
    chassis.moveToPoint(-58, -60, 2000, {}, false);
    pros::delay(200);
    setDrive(4000,4000);
...
//     clamp.set_value(true);
//     chassis.setPose(57.375, -15, 180);
//     chassis.moveToPoint(57.375, 0, 1200, {.forwards=false}, false);
//     chassis.turnToHeading(90, 800, {}, false);
//     setDrive(6000, 6000);
//     pros::delay(400);
//     setDrive(0, 0);
//     scoreAllianceStake();
//     chassis.moveToPoint(52, 0, 500, {}, false);
//     chassis.turnToHeading(55, 650, {}, false); 
//     chassis.moveToPoint(23,-23, 1200, {.forwards=false}, false);
//     clamp.set_value(false);
//     chassis.waitUntilDone();
//     pros::delay(300);
//     chassis.turnToHeading(180, 700, {}, false);
//     setIntake(127);
//     chassis.moveToPoint(23,-51, 1000, {}, false);
//     setIntake(0);
//     chassis.turnToHeading(105, 700, {}, false);
//     chassis.moveToPoint(49,-57, 600, {}, false);
//     doinker.set_value(false);
//     pros::delay(300);
...
//     pros::delay(300);
//     setIntake(127);
//     chassis.moveToPoint(56, -47, 300, {}, false);
//     chassis.turnToHeading(300, 600, {}, false);
//     setIntake(0);
//     chassis.moveToPoint(12, -13, 1500, {}, false);
...
void bramptonRedPosQual(){
    ...
    chassis.moveToPoint(-57.375, 2, 500, {.forwards=false}, false); // go back
    chassis.turnToHeading(180, 600, {}, false); 
    ...
    chassis.turnToHeading(180, 600, {}, false);
    setIntake(127);
    chassis.moveToPoint(-23, -49, 2000, {.maxSpeed=100}, false);
    pros::delay(300);
    setIntake(-50);
    chassis.turnToHeading(-107, 450, {}, false);
    setIntake(127);
    chassis.moveToPoint(-58, -60, 1000, {}, false);
    setDrive(6000,6000);
    setDrive(0,0);
    chassis.turnToHeading(395, 400, {}, false);
    arm.move_velocity(6000);
...
void skillsprog() {
    ...
    chassis.moveToPoint(24, 36, 1500, {}, true); //29,44.4
    chassis.waitUntil(20);
    setarm();
    chassis.waitUntilDone();

    // back up to alliance line
    chassis.turnToHeading(73, 300,{},false);
    setDrive(-8000, -8000);
    pros::delay(750);
    setDrive(-3000, -3000);
    ...
    setDrive(0, 0);
    chassis.moveToPoint(chassis.getPose().x+3, chassis.getPose().y+1, 300, {}, false);
    // pros::delay(1000);
    //setIntake(127);
    //chassis.waitUntilDone();
    // pros::delay(500);
    ...
    chassis.turnToPoint(0, 63,500, {}, false);
    setIntake(127);
   
    chassis.moveToPoint(chassis.getPose().x, chassis.getPose().y + 36, 1000, {.maxSpeed=70}, false);
    setDrive(8000,8000);
    pros::delay(300);
    scoreWallStake();
    setDrive(0,0);
    ...
    chassis.setPose(0,66,chassis.getPose().theta);
    ...
    // setIntake(127);
    //pros::delay(500);
    //chassis.moveToPoint(-46, chassis.getPose().y, 750, {.maxSpeed=60}, false);
    // pros::delay(250);
    chassis.moveToPoint(-68,chassis.getPose().y,1300,{.maxSpeed=65},false);
    ...
    chassis.moveToPoint(-47,59,500, {}, false);
    // pros::delay(1000); // for testing
    chassis.turnToHeading(90,400);
    chassis.moveToPoint(-60,59,400,{.forwards = false},false);
    ...
    setIntake(0);
    chassis.turnToHeading(135,500,{},false);
    chassis.setPose(chassis.getPose().x,38,chassis.getPose().theta);
    ...
    chassis.moveToPoint(-48,12,900,{}, false); //-54
    chassis.turnToHeading(90, 500,{},false);
    setDrive(-10000, -10000);
    pros::delay(800);
    chassis.setPose(-57,chassis.getPose().y,chassis.getPose().theta);    // chassis.turnToHeading(180,500,{},false);
    chassis.moveToPoint(-48,chassis.getPose().y, 400);
    // setDrive(-8000,-8000);
    // pros::delay(500);
    // chassis.setPose(-46, 62, chassis.getPose().theta);
    // pros::delay(1000); // for testing
    ...
    // chassis.moveToPoint(chassis.getPose().x, 10,1300,{},false); // was x=-52
    chassis.turnToHeading(0,500,{},false);
    chassis.moveToPoint(chassis.getPose().x,-30,4800,{.forwards = false, .maxSpeed = 65},false); // was x=-52
    clamp.set_value(false);
    pros::delay(200);
    ...
    setIntake(127);
    chassis.moveToPoint(-24,chassis.getPose().y,700,{},false);
    chassis.swingToHeading(135, DriveSide::LEFT, 700, {.direction = AngularDirection::CW_CLOCKWISE}, false);
    chassis.moveToPoint(18,-43,1600,{}); //23.5, -45; 23.5, -38
    chassis.waitUntil(20);
    setarm();
    chassis.waitUntilDone();
    // chassis.turnToHeading(180,500,{},false);
    ...
    // pros::delay(700);
    // setDrive(0,0);
    // chassis.setPose(24, -60, 180);

    // chassis.moveToPoint(chassis.getPose().x, -45, 700,{.forwards = false},false);
    // back up to alliance line
    chassis.turnToHeading(107, 300,{},false);
    setDrive(-8000, -8000);
    pros::delay(750);
    setDrive(-3000, -3000);
    while (colorsensor.get_hue() < 33) {
    ...
    // chassis.turnToHeading(100,500,{},false);
    // chassis.moveToPoint(-1.9,-37,900,{.forwards = false}, false);
    setIntake(-50);
    pros::delay(100);
    setIntake(0);
    arm.move(60);
    ...
    arm.move_velocity(0);
    setIntake(127);
    chassis.moveToPoint(chassis.getPose().x,-69,1000,{.maxSpeed = 65}, false);
    setDrive(8000, 8000);
    pros::delay(300);
    scoreWallStake();
    setDrive(0, 0);
    ...
    chassis.setPose(0,-64.5,chassis.getPose().theta);
    chassis.moveToPoint(chassis.getPose().x,-50,700,{.forwards = false}, false);
    // scoreWallStake();
    // pros::delay(850);
    ...
    setIntake(127);
    pros::delay(550);
    chassis.moveToPoint(-47,chassis.getPose().y,900,{},false); 
    chassis.moveToPoint(-64,chassis.getPose().y,1400,{.maxSpeed = 55},false);
    chassis.setPose(-50,chassis.getPose().y,chassis.getPose().theta);
    arm.move(0);
    chassis.turnToHeading(140,500,{},false);
    chassis.moveToPoint(-42,-58,700,{},false); // was -46, -58
    chassis.turnToHeading(90,500,{},false);
    chassis.moveToPoint(-62,-58,700,{.forwards = false}, false);
    chassis.turnToHeading(45,500,{},false);
    setDrive(-9000, -9000);
    pros::delay(500);
    setDrive(0, 0);
    ...
    setIntake(0);
    chassis.turnToHeading(135,500,{},false);
    chassis.setPose(chassis.getPose().x,58,chassis.getPose().theta);
    ...
    chassis.moveToPoint(-47,49,700,{}, false); //-54
    chassis.turnToHeading(180,500,{},false);
    // setDrive(-8000,-8000);
    // pros::delay(500);
    // chassis.setPose(-46, 62, chassis.getPose().theta);
    ...
    chassis.moveToPoint(chassis.getPose().x, 10,1300,{},false); // was x=-52
    chassis.turnToHeading(0,500,{},false);
    chassis.moveToPoint(chassis.getPose().x,-19,4800,{.forwards = false, .maxSpeed = 65},false); // was x=-52
    clamp.set_value(false);
    pros::delay(100);

    // alliance stake
    // chassis.moveToPoint(58, 3, 750, {}, false);
    // chassis.turnToHeading(281, 350, {}, false);
    // pros::delay(100);
    // setIntake(127);
    // pros::delay(300);
    // setIntake(0);
    ...
    // get ring
    // chassis.moveToPoint(47, 4, 500, {}, false);

    chassis.turnToHeading(190,400,{},false);
    // chassis.swingToHeading(190, DriveSide::RIGHT, 1000, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE}, false);
    setIntake(127);
    chassis.moveToPoint(37,-47,900,{},false);
    pros::delay(200);
    chassis.moveToPoint(37,-56,600,{},false);
    ...
    chassis.turnToHeading(20, 400, {}, false);
    arm.move_velocity(12000);
    setIntake(-127);
    chassis.moveToPoint(60, 25, 1500, {}, false);
    chassis.moveToPoint(60, 54, 1500, {.minSpeed=127}, false);
    arm.move_velocity(0);
    // setDrive(-12000, -12000);
    // pros::delay(200);
    // setDrive(0,0);

    chassis.turnToHeading(50,550,{},false);
    setIntake(0);
    setDrive(-12000,-12000);
    pros::delay(1500);
    setDrive(12000, 12000);
...
void peakpikesblueneg5ringelim() {
    ...
    pros::delay(100);
    setIntake(127);
    chassis.moveToPose(14,58,1,2500,{.maxSpeed=80},false); //DO y=62 IF FIRST STAGE ShiTs ITSELF (also )
    pros::delay(200);
    setIntake(-50);
    pros::delay(150);
    setIntake(127);
    ...
    chassis.turnToHeading(205,500,{},false);
    setDrive(6000,6000);
    pros::delay(1600);
    setDrive(0,0);
    arm.move_velocity(600);
    ...
    */
    ...
    //for ELIM:
    /*
    chassis.moveToPoint(chassis.getPose().x-12,chassis.getPose().y-12,800,{.forwards=false},false);
    chassis.turnToHeading(160,500,{},false);
    pros::delay(250);
    //chassis.moveToPoint(35,23,1300,{.forwards=false},true);
    //setDrive(-6000,-6000);
    //pros::delay(1500);
    //setDrive(0,0);
    //chassis.turnToPoint(47,2,500, {}, false);
    chassis.moveToPoint(54,16,1200,{.maxSpeed=90},false);
    doinker.set_value(true);
    pros::delay(15000);
...
void peakpikesredneg5ringelim() {
    ...
    chassis.setPose(-51,24,-90);
    chassis.moveToPoint(-28,24,1500,{.forwards=false,.maxSpeed=70},false);//60
    chassis.waitUntil(17);
    clamp.set_value(false);
    pros::delay(100);
    setIntake(127);
...
void provposblueelim() {
    ...
    chassis.setPose(48, -33, -112);
    setIntake(127);
    chassis.moveToPoint(19,-44,1600, {.minSpeed = 127}, false); //21, -43
    doinker.set_value(true);
    ...
    chassis.turnToHeading(-270, 800, {}, false);
    chassis.moveToPoint(11,-49, 900, {.forwards = false, .maxSpeed = 75}, false);
    clamp.set_value(false);
    setIntake(127);
...
void provsrednegqual() {
    ...
    chassis.moveToPoint(-57.375, 25, 1000, {.forwards = false}, false);
    chassis.turnToHeading(270, 650, {}, false);
    chassis.moveToPoint(-23, 25, 1500, {.forwards=false, .maxSpeed=60}, true);
    chassis.waitUntil(26);

    clamp.set_value(false); // clamp mogo
    pros::delay(100);
    chassis.turnToHeading(40, 600, {}, false);
    chassis.moveToPoint(-14, 37, 1800, {}, false);
    pros::delay(300);
    
    chassis.moveToPoint(-23, 23, 1200, {.forwards=false}, true);
    chassis.turnToHeading(0, 450, {}, false);
    setIntake(127);
    chassis.moveToPoint(-24, 48, 2000, {}, false);
    pros::delay(300);
    chassis.turnToHeading(-60, 450, {}, false);
    ...
    chassis.setPose(-59,59,chassis.getPose().theta);
    chassis.moveToPoint(-23, 23, 1800, {.forwards=false}, true);
    chassis.turnToHeading(180, 450, {}, false);
...
void provsredelim() {
    ...
    chassis.setPose(-48, -58, 68);
    setIntake(127);
    chassis.moveToPoint(-20,-48, 1200, {.minSpeed = 127}, false); //21, -43
    doinker.set_value(true);

    setIntake(0);
    chassis.moveToPoint(-25,-50,600, {.forwards = false}, false);
    chassis.turnToHeading(180, 800, {}, false);
    doinker.set_value(false);
    chassis.turnToHeading(-45, 300, {}, false);

    // chassis.moveToPoint(chassis.getPose().x, -20, 700, {.forwards = false, .maxSpeed = 70}, false);
    // chassis.waitUntil(19);
    // clamp.set_value(false);
    // pros::delay(100);
    // setIntake(127);
    ...
    // chassis.turnToHeading(270, 750, {}, false);
    // // pros::delay(1000);
    // chassis.moveToPoint(-48,chassis.getPose().y, 1000, {}, false);
    ...
    // chassis.turnToHeading(70, 1500, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE}, false);
    // doinker.set_value(false);
    // chassis.turnToHeading(90, 800, {}, false);
