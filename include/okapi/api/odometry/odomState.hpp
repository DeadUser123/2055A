...
struct OdomState {
   ...
   *   - `OdomState::str(1_tile, 1_radian)`: d1 tiles and angle radians.
   *
   * Throws std::domain_error if the units passed are undefined.
   *
   * @param idistanceUnit The units you want your d1 to be in. This must be an exact, predefined QLength (such as foot, meter, inch, tile etc.).
   ...
   *   - `OdomState::str(6_tile / 100, "%", 360_deg / 100, "%")` to get the d1 values in % of the vex field, and angle values in % of a full rotation.
   *
   * @param idistanceUnit The units you want your d1 to be in. The x or y position will be output in multiples of this length.
   * @param distUnitName The suffix you as your d1 unit.
